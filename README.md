...
2. **Add Local Workflow Files**
   ...
   - Add the following workflow files:
      ...
      jobs:
        update:
          uses: happy-changelog/happy-changelog-workflow/.github/workflows/update-changelog.yml@v1.6.1
          permissions:
            contents: write
          with:
            changelog-file: CHANGELOG.md
      ...
      jobs:
        release:
          uses: happy-changelog/happy-changelog-workflow/.github/workflows/edit-release.yml@v1.6.1
          permissions:
            contents: write
          with:
            changelog-file: CHANGELOG.md
